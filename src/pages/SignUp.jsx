    ...
    <section>
     ...
     <div className="flex justify-center flex-wrap  items-center   px-6 py-12 max-w-6xl mx-auto">
        <div className="md:w-[67%] lg:w-[50%] mb-12 md:mb-6">
          <img src="https://images.unsplash.com/photo-1605858286629-4268180c482b?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1yZWxhdGVkfDE0fHx8ZW58MHx8fHx8&auto=format&fit=crop&w=600&q=60" alt="key" 
       ...
       <div className="w-full md:w-[67%] lg:w-[40%] lg:ml-20">
         <form onSubmit={onSubmit}>
          ...
          <div 
             className='my-4 before:border-t 
              flex before:flex-1 items-center
