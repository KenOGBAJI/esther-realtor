      ...
      <Swiper 
       ...
       <div className="fixed top-[13%] right-[3%] z-10 bg-white cursor-pointer border-2 border-gray- rounded-full w-12 h-12 flex justify-center items-center" 
        ...
        setTimeout(() => {
         ...
         {shareLinkCopied 
        && (
         <p className='fixed top-[23%] right-[5%] font-semibold border-2 border-gray- rounded-md bg-white z-10 p-2'>
           Link Copied
        </p>
        )}
       <div className="m-4 flex flex-col md:flex-row max-w-6xl lg:mx-auto p-4 rounded-lg shadow-lg bg-white lg:space-x-5">
        <div className="bg-pink-300 w-full h-[200px] lg-[400px]">
          ...
          <p className='flex items-center mt-6 mb-3 ml-4 font-semibold'>
